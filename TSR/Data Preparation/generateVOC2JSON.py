...
def generateVOC2Json(rootDir,xmlFiles):
  ...
  with open("/content/drive/My Drive/dataset/coco.json", "w") as f:
    f.write(jsonString)

# Path to the txt file (see at the top of this script)
trainFile = "/content/drive/My Drive/dataset/coco.txt"
trainXMLFiles = list()
...
rootDir = "/content/drive/My Drive/dataset/2Be Fine Tuned"
