...
def ModelConstructor():
    '''
        This function makes the extractor architecture and returns the model object after loading the trained weights.
    '''
    ...
    extractor= Model(inputs=model_input, outputs=[table_out, column_out])

    # loading the weights
    extractor.load_weights('DenseNet21.h5')
...
if uploader is not None:
    ...
    img, table_mask, col_mask = predict_masks(decoded_image, extractor)
